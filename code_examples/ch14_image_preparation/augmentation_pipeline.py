...
def create_augmentation_pipeline(
    mode: str = "standard", target_size: Tuple[int, int] = (224, 224)
) -> Callable:
    """
...
def generate_positive_pairs(image, augment_fn: Callable, num_pairs: int = 2) -> List:
    """
...
class ContrastiveAugmentor:
    ...
    def __init__(self, target_size: Tuple[int, int] = (224, 224), num_views: int = 2):
        import torchvision.transforms as T
