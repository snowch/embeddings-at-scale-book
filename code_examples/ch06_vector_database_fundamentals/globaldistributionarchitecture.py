...
full_rep_cost = cost_model.calculate_total_cost(
    strategy="full_replication", num_vectors=256_000_000_000_000, embedding_dim=768, qps=1_000_000
)

tiered_cost = cost_model.calculate_total_cost(
    strategy="tiered", num_vectors=256_000_000_000_000, embedding_dim=768, qps=1_000_000
)

print(f"Full Replication: ${full_rep_cost['total_monthly_cost']:,.0f}/month")
print(f"Tiered: ${tiered_cost['total_monthly_cost']:,.0f}/month")
print(
    f"Savings: {(1 - tiered_cost['total_monthly_cost'] / full_rep_cost['total_monthly_cost']) * 100:.1f}%"
)
