    ...
    def core_metrics(self):
        ...
        return {
            ...
            "recall_at_k": {
                ...
                "typical_targets": {"recall@10": ">0.95", "recall@100": ">0.98"},
            ...
            "throughput": {
                ...
                "typical_targets": {"per_shard": "1K-10K QPS", "global": "100K-1M QPS"},
    ...
    def sla_vs_slo_vs_sli(self):
        ...
        return {
            "sli": {
                ...
                "examples": ["p99 query latency: 78ms", "recall@10: 0.96", "availability: 99.97%"],
            },
            "slo": {
                "name": "Service Level Objective",
                "definition": "Target value for an SLI",
                "examples": ["p99 latency < 100ms", "recall@10 > 0.95", "availability > 99.99%"],
