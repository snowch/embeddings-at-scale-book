...
class InnovationPipeline:
    ...
    def record_impact(self, innovation_id: str, achieved_impact: str, lessons: List[str]) -> None:
    ...
    def get_active_innovations(self) -> List[Innovation]:
        ...
        return [
            inn
            for inn in self.innovations.values()
    ...
    def get_innovations_by_stage(self, stage: InnovationStage) -> List[Innovation]:
        ...
        return [inn for inn in self.innovations.values() if inn.stage == stage]

    def calculate_roi(self) -> Dict[str, any]:
        """Calculate ROI of innovation program"""
        completed = [
            inn for inn in self.innovations.values() if inn.stage == InnovationStage.COMPLETED
        ]
    ...
    def generate_innovation_report(self) -> str:
        ...
        if completed:
            ...
            for inn in completed:
                duration = (
                    (inn.actual_completion - inn.start_date).days if inn.actual_completion else 0
                )
