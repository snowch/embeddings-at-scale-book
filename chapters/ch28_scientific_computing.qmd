...
```python
{{< include /code_examples/ch28_scientific_computing/astrophysics.py >}}
```
...
```python
{{< include /code_examples/ch28_scientific_computing/climate.py >}}
```
...
```python
{{< include /code_examples/ch28_scientific_computing/materials.py >}}
```
...
```python
{{< include /code_examples/ch28_scientific_computing/particle_physics.py >}}
```
...
```python
{{< include /code_examples/ch28_scientific_computing/ecology.py >}}
```
