...
```python
{{< include /code_examples/ch33_monitoring_observability/class.py >}}
```
...
```python
{{< include /code_examples/ch33_monitoring_observability/metrictype.py >}}
```
...
```python
{{< include /code_examples/ch33_monitoring_observability/class_1.py >}}
```
...
```python
{{< include /code_examples/ch33_monitoring_observability/class_2.py >}}
```
...
```python
{{< include /code_examples/ch33_monitoring_observability/class_3.py >}}
```
