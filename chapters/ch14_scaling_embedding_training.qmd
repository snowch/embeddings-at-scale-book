...
```python
{{< include /code_examples/ch14_scaling_embedding_training/distributedembeddingtable.py >}}
```bash
...
```python
{{< include /code_examples/ch14_scaling_embedding_training/gradientaccumulationtrainer.py >}}
```
...
```python
{{< include /code_examples/ch14_scaling_embedding_training/mixedprecisiontrainer.py >}}
```
...
```python
{{< include /code_examples/ch14_scaling_embedding_training/checkpointedtransformerlayer.py >}}
```
...
```python
{{< include /code_examples/ch14_scaling_embedding_training/memoryefficientoptimizer.py >}}
```
...
```python
{{< include /code_examples/ch14_scaling_embedding_training/embeddingdataset.py >}}
```
...
```python
{{< include /code_examples/ch14_scaling_embedding_training/setup_multi_node.py >}}
```bash
...
```python
{{< include /code_examples/ch14_scaling_embedding_training/from.py >}}
```
...
```python
{{< include /code_examples/ch14_scaling_embedding_training/spotinstancetrainer.py >}}
```
