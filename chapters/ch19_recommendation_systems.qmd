...
```python
{{< include /code_examples/ch19_recommendation_systems/from.py >}}
```
...
```python
{{< include /code_examples/ch19_recommendation_systems/class.py >}}
```
...
```python
{{< include /code_examples/ch19_recommendation_systems/from_1.py >}}
```
...
```python
{{< include /code_examples/ch19_recommendation_systems/from_2.py >}}
```
...
```python
{{< include /code_examples/ch19_recommendation_systems/crossdomainrecommender.py >}}
```
