...
The next chapter, @sec-entity-resolution, covers a particularly important cross-industry challenge: identifying and linking records that refer to the same real-world entities across disparate data sources—a problem that scales to trillions of comparison pairs.

Following entity resolution, the remaining chapters in Part V explore industry-specific applications:
