...
```python
{{< include /code_examples/ch17_automated_decision_systems/from.py >}}
```
...
```python
{{< include /code_examples/ch17_automated_decision_systems/class.py >}}
```
...
```python
{{< include /code_examples/ch17_automated_decision_systems/class_1.py >}}
```
...
```python
{{< include /code_examples/ch17_automated_decision_systems/class_2.py >}}
```
...
```python
{{< include /code_examples/ch17_automated_decision_systems/class_3.py >}}
```
