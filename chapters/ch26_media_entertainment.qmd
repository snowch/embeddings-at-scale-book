...
```python
{{< include /code_examples/ch26_media_entertainment/class.py >}}
```
...
```python
{{< include /code_examples/ch26_media_entertainment/class_1.py >}}
```
...
```python
{{< include /code_examples/ch26_media_entertainment/class_2.py >}}
```
...
```python
{{< include /code_examples/ch26_media_entertainment/class_3.py >}}
```
...
```python
{{< include /code_examples/ch26_media_entertainment/class_4.py >}}
```
