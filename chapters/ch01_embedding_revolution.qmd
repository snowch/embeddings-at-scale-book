...
flowchart TB
    ...
    subgraph embedding["Embedding Workflow"]
        ...
        subgraph query["Query Time (per request)"]
            direction LR
            UserQuery[User Query] --> QEncoder[Embedding Model<br/>same as index] --> QVec[Query Vector]
    ...
    style classification fill:#ffcccc,stroke:#cc0000,color:#000000
    style embedding fill:#f5f5f5,stroke:#666666
    style index fill:#ccffcc,stroke:#00aa00,color:#000000
    style query fill:#cce5ff,stroke:#0066cc,color:#000000
```
