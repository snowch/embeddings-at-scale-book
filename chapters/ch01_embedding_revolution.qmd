...
In @lst-word-embedding-basics we used hand-crafted values to illustrate the concept. Here we use a pre-trained sentence transformer model to create real embeddings—we explain how these models learn in @sec-embedding-model-fundamentals:
