...
# A simple 3-dimensional embedding space
word_embeddings = {
    'king':   np.array([0.9, 0.8, 0.1]),
    'queen':  np.array([0.9, 0.8, 0.9]),
    'man':    np.array([0.5, 0.2, 0.1]),
    'woman':  np.array([0.5, 0.2, 0.9]),
    'apple':  np.array([0.1, 0.3, 0.5]),
}
...
print(f"king vs queen: {similarity('king', 'queen'):.3f}")  # High similarity
print(f"man vs woman: {similarity('man', 'woman'):.3f}")    # High similarity
print(f"king vs apple: {similarity('king', 'apple'):.3f}")  # Low similarity
```
