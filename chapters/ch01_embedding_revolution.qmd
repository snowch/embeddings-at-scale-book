...
print(f"One-hot encoding: {one_hot_dimensions:,} dimensions ({one_hot_nonzero} non-zero)")
print(f"Embedding: {embedding_dimensions} dimensions ({embedding_nonzero} non-zero)")
