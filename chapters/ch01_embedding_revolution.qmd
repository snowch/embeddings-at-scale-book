...
Embeddings can represent virtually any type of data. Here's a landscape of the major embedding types you'll encounter:
...
: Common embedding types and their applications {.striped}
...
We explore each type in depth in @sec-embedding-types-modalities, and cover how the underlying models work in @sec-embedding-model-fundamentals.
