...
Word embeddings map words to vectors, capturing semantic and syntactic relationships. Here we use a pre-trained sentence transformer model—see @sec-contrastive-learning and @sec-self-supervised-learning for how these models are trained:
...
Images can be embedded into vectors that capture visual content. We use a pre-trained ResNet model here—see @sec-image-preparation for how CNN-based image embedding models work:
