...
```python
{{< include /code_examples/ch12b_text_chunking/fixed_size_chunking.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/sentence_chunking.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/paragraph_chunking.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/semantic_chunking.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/recursive_chunking.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/sliding_window_chunking.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/pdf_chunking.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/html_chunking.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/markdown_chunking.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/code_chunking.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/chunk_size_evaluation.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/metadata_preservation.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/table_chunking.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/list_chunking.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/code_block_handling.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/production_pipeline.py >}}
```
...
```python
{{< include /code_examples/ch12b_text_chunking/chunk_evaluation.py >}}
```
