...
```python
{{< include /code_examples/ch06_custom_embedding_strategies/embeddingfinetuner.py >}}
```
...
```python
{{< include /code_examples/ch06_custom_embedding_strategies/domainspecificobjectives.py >}}
```
...
```python
{{< include /code_examples/ch06_custom_embedding_strategies/constrainedembeddingobjective.py >}}
```
...
```python
{{< include /code_examples/ch06_custom_embedding_strategies/multiobjectiveoptimization.py >}}
```
...
```python
{{< include /code_examples/ch06_custom_embedding_strategies/dimensionalityexperiment.py >}}
```
...
```python
{{< include /code_examples/ch06_custom_embedding_strategies/intrinsicdimensionality.py >}}
```
...
```python
{{< include /code_examples/ch06_custom_embedding_strategies/progressivedimensionreduction.py >}}
```
...
```python
{{< include /code_examples/ch06_custom_embedding_strategies/binaryembeddings.py >}}
```
...
```python
{{< include /code_examples/ch06_custom_embedding_strategies/costperformancefrontier.py >}}
```
