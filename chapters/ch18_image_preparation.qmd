...
```python
{{< include /code_examples/ch18_image_preparation/cnn_embeddings.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/vit_embeddings.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/preprocessing_pipeline.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/resolution_handling.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/color_normalization.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/quality_assessment.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/tiling_strategy.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/multi_resolution.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/satellite_imagery.py >}}
```

#### Medical Imaging (Pathology Slides)

```python
{{< include /code_examples/ch18_image_preparation/pathology_slides.py >}}
```

#### Document Images

```python
{{< include /code_examples/ch18_image_preparation/document_images.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/object_detection_embedding.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/segmentation_embedding.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/attention_regions.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/scene_vs_object.py >}}
```

### Hybrid Approaches

```python
{{< include /code_examples/ch18_image_preparation/hybrid_embedding.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/augmentation_pipeline.py >}}
```

### Augmentation for Contrastive Learning

```python
{{< include /code_examples/ch18_image_preparation/contrastive_augmentation.py >}}
```

### Domain-Specific Augmentation

```python
{{< include /code_examples/ch18_image_preparation/domain_augmentation.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/video_frames.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/production_pipeline.py >}}
```
...
```python
{{< include /code_examples/ch18_image_preparation/consistency_checks.py >}}
```

### Batch Processing Best Practices

```python
{{< include /code_examples/ch18_image_preparation/batch_processing.py >}}
```
