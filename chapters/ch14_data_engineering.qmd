...
```python
{{< include /code_examples/ch14_data_engineering/from.py >}}
```
...
```python
{{< include /code_examples/ch14_data_engineering/class.py >}}
```
...
```python
{{< include /code_examples/ch14_data_engineering/from_1.py >}}
```
...
```python
{{< include /code_examples/ch14_data_engineering/from_2.py >}}
```
...
```python
{{< include /code_examples/ch14_data_engineering/from_3.py >}}
```
