...
Medical ontologies, scientific taxonomies, and corporate knowledge bases benefit enormously from hyperbolic embeddings. Example: ICD-10 disease hierarchies with 14,000+ diseases.

**Disease Taxonomy Example:**
...
**Hyperbolic embeddings** in 10-20 dimensions can outperform Euclidean embeddings in 300-500 dimensions for such hierarchies. Train using contrastive loss where:

- Positive pairs: Parent-child relationships (e.g., "angina" ↔ "ischemic_heart_disease")
- Negative pairs: Cross-hierarchy diseases (e.g., "angina" ↔ "pneumonia")
