...
```python
{{< include /code_examples/ch25_retail_ecommerce/class.py >}}
```
...
```python
{{< include /code_examples/ch25_retail_ecommerce/styleattribute.py >}}
```
...
```python
{{< include /code_examples/ch25_retail_ecommerce/demandregime.py >}}
```
...
```python
{{< include /code_examples/ch25_retail_ecommerce/actiontype.py >}}
```
...
```python
{{< include /code_examples/ch25_retail_ecommerce/productrelationtype.py >}}
```
