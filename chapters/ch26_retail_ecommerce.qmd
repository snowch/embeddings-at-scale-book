...
```python
{{< include /code_examples/ch26_retail_ecommerce/class.py >}}
```
...
```python
{{< include /code_examples/ch26_retail_ecommerce/styleattribute.py >}}
```
...
```python
{{< include /code_examples/ch26_retail_ecommerce/demandregime.py >}}
```
...
```python
{{< include /code_examples/ch26_retail_ecommerce/actiontype.py >}}
```
...
```python
{{< include /code_examples/ch26_retail_ecommerce/productrelationtype.py >}}
```
