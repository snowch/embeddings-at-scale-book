...
mid_AB = (A + B) / 2
mid_AC = (A + C) / 2
ax.text(mid_AB[0]+0.1, mid_AB[1]-0.3, f'd = {dist_AB:.2f}', fontsize=11, color='#16a34a', fontweight='bold')
ax.text(mid_AC[0]-0.6, mid_AC[1]+0.1, f'd = {dist_AC:.2f}', fontsize=11, color='#dc2626', fontweight='bold')
