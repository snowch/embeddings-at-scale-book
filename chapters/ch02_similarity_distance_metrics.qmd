...
# Use different line styles: solid (thick), dashed (medium), dotted (fine)
...
ax1.annotate('', xy=C, xytext=origin, arrowprops=dict(arrowstyle='->', color='#dc2626', lw=1, linestyle=(0, (1, 2))))
...
ax2.set_ylim(0, 24)  # Add top padding for labels
