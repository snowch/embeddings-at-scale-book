...
# Use different line styles: solid (thick), dashed (medium), dotted (lighter)
...
ax1.annotate('', xy=C, xytext=origin, arrowprops=dict(arrowstyle='->', color='#dc2626', lw=1.5, linestyle=(0, (1, 1))))
