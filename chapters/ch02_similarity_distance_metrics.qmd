...
# Labels
ax.text(A[0]+0.1, A[1]+0.2, 'A', fontsize=14, fontweight='bold', color='#2563eb')
ax.text(B[0]+0.1, B[1]+0.2, 'B (2× length)', fontsize=12, fontweight='bold', color='#16a34a')
ax.text(C[0]+0.1, C[1]+0.2, 'C (0.5× length)', fontsize=12, fontweight='bold', color='#dc2626')
