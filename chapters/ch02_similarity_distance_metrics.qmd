...
ax1.annotate('', xy=B, xytext=origin, arrowprops=dict(arrowstyle='->', color='#16a34a', lw=3, linestyle='-'))
ax1.annotate('', xy=A, xytext=origin, arrowprops=dict(arrowstyle='->', color='#2563eb', lw=3, linestyle='--'))
ax1.annotate('', xy=C, xytext=origin, arrowprops=dict(arrowstyle='->', color='#dc2626', lw=3, linestyle=':'))

ax1.text(A[0]+0.15, A[1]+0.25, 'A (dashed)', fontsize=11, fontweight='bold', color='#2563eb')
ax1.text(B[0]+0.15, B[1]+0.25, 'B 1.5× (solid)', fontsize=11, fontweight='bold', color='#16a34a')
ax1.text(C[0]+0.15, C[1]-0.35, 'C 0.5× (dotted)', fontsize=11, fontweight='bold', color='#dc2626')
