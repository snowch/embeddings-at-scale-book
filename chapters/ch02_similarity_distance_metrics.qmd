...
# Left panel: vectors with slight offset for visibility
origin = [0, 0]
# Base direction
A = np.array([3, 2])
# Same direction, different magnitudes (slight visual offset)
B = np.array([4.5, 3.1])     # ~1.5x magnitude, tiny angle offset
C = np.array([1.5, 0.9])     # ~0.5x magnitude, tiny angle offset

ax1.annotate('', xy=A, xytext=origin, arrowprops=dict(arrowstyle='->', color='#2563eb', lw=3))
ax1.annotate('', xy=B, xytext=origin, arrowprops=dict(arrowstyle='->', color='#16a34a', lw=3))
ax1.annotate('', xy=C, xytext=origin, arrowprops=dict(arrowstyle='->', color='#dc2626', lw=3))

ax1.text(A[0]+0.1, A[1]+0.2, 'A', fontsize=14, fontweight='bold', color='#2563eb')
ax1.text(B[0]+0.1, B[1]+0.2, 'B (1.5×)', fontsize=12, fontweight='bold', color='#16a34a')
ax1.text(C[0]+0.1, C[1]-0.3, 'C (0.5×)', fontsize=12, fontweight='bold', color='#dc2626')
