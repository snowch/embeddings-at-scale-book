...
# Left panel: vectors from same origin, same direction, dashed lines layered
origin = np.array([0, 0])
...
# Draw longest first, then medium, then shortest - dashed lines so colors show through
ax1.annotate('', xy=B, xytext=origin, arrowprops=dict(arrowstyle='->', color='#16a34a', lw=4, linestyle='--', alpha=0.7))
ax1.annotate('', xy=A, xytext=origin, arrowprops=dict(arrowstyle='->', color='#2563eb', lw=3, linestyle='--'))
ax1.annotate('', xy=C, xytext=origin, arrowprops=dict(arrowstyle='->', color='#dc2626', lw=2, linestyle='--'))

ax1.text(A[0]+0.15, A[1]+0.3, 'A', fontsize=11, fontweight='bold', color='#2563eb')
ax1.text(B[0]+0.15, B[1]+0.2, 'B (1.5×)', fontsize=11, fontweight='bold', color='#16a34a')
ax1.text(C[0]-0.7, C[1]+0.25, 'C (0.5×)', fontsize=11, fontweight='bold', color='#dc2626')
