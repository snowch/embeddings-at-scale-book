...
```python
{{< include /code_examples/ch20_semantic_search/from.py >}}
```
...
```python
{{< include /code_examples/ch20_semantic_search/import.py >}}
```
...
```python
{{< include /code_examples/ch20_semantic_search/from_1.py >}}
```
...
```python
{{< include /code_examples/ch20_semantic_search/from_2.py >}}
```
...
```python
{{< include /code_examples/ch20_semantic_search/import_1.py >}}
```
