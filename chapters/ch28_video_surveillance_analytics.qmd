...
```python
{{< include /code_examples/ch25_video_surveillance/realtime_processing.py >}}
```
...
```python
{{< include /code_examples/ch25_video_surveillance/person_reid.py >}}
```
...
```python
{{< include /code_examples/ch25_video_surveillance/action_recognition.py >}}
```
...
```python
{{< include /code_examples/ch25_video_surveillance/anomaly_detection.py >}}
```
...
```python
{{< include /code_examples/ch25_video_surveillance/forensic_search.py >}}
```
...
```python
{{< include /code_examples/ch25_video_surveillance/retail_analytics.py >}}
```
...
```python
{{< include /code_examples/ch25_video_surveillance/smart_city.py >}}
```
...
```python
{{< include /code_examples/ch25_video_surveillance/manufacturing_safety.py >}}
```
...
```python
{{< include /code_examples/ch25_video_surveillance/privacy_preservation.py >}}
```
