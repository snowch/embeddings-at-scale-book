...
```python
{{< include /code_examples/ch17_rag_at_scale/from.py >}}
```
...
```python
{{< include /code_examples/ch17_rag_at_scale/passageextractor.py >}}
```
...
```python
{{< include /code_examples/ch17_rag_at_scale/multistageretriever.py >}}
```
...
```python
{{< include /code_examples/ch17_rag_at_scale/from_1.py >}}
```
...
```python
{{< include /code_examples/ch17_rag_at_scale/from_2.py >}}
```
