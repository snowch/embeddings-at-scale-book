...
```python
{{< include /code_examples/ch10_siamese_networks/contrastiveloss.py >}}
```
...
```python
{{< include /code_examples/ch10_siamese_networks/enterpriseoptimizedsiamesenetwork.py >}}
```
...
```python
{{< include /code_examples/ch10_siamese_networks/tripletloss.py >}}
```
...
```python
{{< include /code_examples/ch10_siamese_networks/advancedtripletloss.py >}}
```
...
```python
{{< include /code_examples/ch10_siamese_networks/balancedbatchsampler.py >}}
```
...
```python
{{< include /code_examples/ch10_siamese_networks/oneshotclassifier.py >}}
```
...
```python
{{< include /code_examples/ch10_siamese_networks/prototypicalnetworkclassifier.py >}}
```
...
```python
{{< include /code_examples/ch10_siamese_networks/adaptivethresholdmanager.py >}}
```
...
```python
{{< include /code_examples/ch10_siamese_networks/siameseembeddingservice.py >}}
```
...
```python
{{< include /code_examples/ch10_siamese_networks/siameseannservice.py >}}
```
