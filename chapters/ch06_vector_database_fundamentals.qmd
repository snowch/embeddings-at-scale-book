...
```python
{{< include /code_examples/ch06_vector_database_fundamentals/geometricintuition.py >}}
```
...
```python
{{< include /code_examples/ch06_vector_database_fundamentals/hierarchicalnavigation.py >}}
```
...
```python
{{< include /code_examples/ch06_vector_database_fundamentals/hnswdeepdive.py >}}
```
...
```python
{{< include /code_examples/ch06_vector_database_fundamentals/ivfpqstrategy.py >}}
```
