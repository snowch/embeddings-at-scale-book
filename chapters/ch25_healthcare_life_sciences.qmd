...
{{< include /code_examples/ch25_healthcare_life_sciences/from.py >}}
```
...
```python
{{< include /code_examples/ch25_healthcare_life_sciences/class.py >}}
```
...
```python
{{< include /code_examples/ch25_healthcare_life_sciences/class_1.py >}}
```
...
```python
{{< include /code_examples/ch25_healthcare_life_sciences/class_2.py >}}
```
...
```python
{{< include /code_examples/ch25_healthcare_life_sciences/class_3.py >}}
```
