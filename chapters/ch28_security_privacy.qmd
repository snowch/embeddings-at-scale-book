...
```python
{{< include /code_examples/ch24_security_privacy/class.py >}}
```
...
```python
{{< include /code_examples/ch24_security_privacy/class_1.py >}}
```
...
```python
{{< include /code_examples/ch24_security_privacy/class_2.py >}}
```
...
```python
{{< include /code_examples/ch24_security_privacy/permission.py >}}
```
...
```python
{{< include /code_examples/ch24_security_privacy/dataregion.py >}}
```
