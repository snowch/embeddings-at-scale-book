...
```python
{{< include /code_examples/ch09_self_supervised_learning/selfsupervisedembeddingframework.py >}}
```
...
```python
{{< include /code_examples/ch09_self_supervised_learning/enterpriseselfsupervisedpipeline.py >}}
```
...
```python
{{< include /code_examples/ch09_self_supervised_learning/domainspecificmlm.py >}}
```
...
```python
{{< include /code_examples/ch09_self_supervised_learning/advancedmlm.py >}}
```
...
```python
{{< include /code_examples/ch09_self_supervised_learning/maskedautoencodervit.py >}}
```
...
```python
{{< include /code_examples/ch09_self_supervised_learning/industrialdefectdetection.py >}}
```
...
```python
{{< include /code_examples/ch09_self_supervised_learning/timeseriesselfsupervised.py >}}
```
...
```python
{{< include /code_examples/ch09_self_supervised_learning/multimodalselfsupervised.py >}}
```
