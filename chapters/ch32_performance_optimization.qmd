...
```python
{{< include /code_examples/ch32_performance_optimization/class.py >}}
```
...
```python
{{< include /code_examples/ch32_performance_optimization/class_1.py >}}
```
...
```python
{{< include /code_examples/ch32_performance_optimization/class_2.py >}}
```
...
```python
{{< include /code_examples/ch32_performance_optimization/class_3.py >}}
```
...
```python
{{< include /code_examples/ch32_performance_optimization/class_4.py >}}
```
