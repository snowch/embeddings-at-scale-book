...
```python
{{< include /code_examples/ch24_defense_intelligence/geoint.py >}}
```
...
```python
{{< include /code_examples/ch24_defense_intelligence/sigint.py >}}
```
...
```python
{{< include /code_examples/ch24_defense_intelligence/osint.py >}}
```
...
```python
{{< include /code_examples/ch24_defense_intelligence/cybersecurity.py >}}
```
...
```python
{{< include /code_examples/ch24_defense_intelligence/autonomous.py >}}
```
...
```python
{{< include /code_examples/ch24_defense_intelligence/decision_support.py >}}
```
