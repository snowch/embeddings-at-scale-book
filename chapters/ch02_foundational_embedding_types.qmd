...
# Community 1 (blue) - triangle with Bob at top
...
# Community 2 (orange) - triangle with Yuki at top
...
# Community 1 embeddings (clustered) - spread out labels to avoid overlap
...
# Community 2 embeddings (clustered separately) - spread out labels
...
- **Multi-modal embeddings** like CLIP enable cross-modal search and zero-shot categorization
