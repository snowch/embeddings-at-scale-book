...
```python
{{< include /code_examples/ch14_high_performance_vector_ops/import.py >}}
```
...
```python
{{< include /code_examples/ch14_high_performance_vector_ops/ivfindex.py >}}
```
...
```python
{{< include /code_examples/ch14_high_performance_vector_ops/gpuvectorsearch.py >}}
```
...
```python
{{< include /code_examples/ch14_high_performance_vector_ops/memorymappedvectorstore.py >}}
```
...
```python
{{< include /code_examples/ch14_high_performance_vector_ops/class.py >}}
```
