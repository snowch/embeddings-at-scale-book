...
```python
{{< include /code_examples/ch07_contrastive_learning/infonceloss.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/temperatureanalysis.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/tripletloss.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/ntxentloss.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/alignmentuniformityanalysis.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/simclrtextembedding.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/mocotextembedding.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/multimodalcontrastive.py >}}
```

**Adaptation 2: Domain-Specific Contrastive Objectives**

```python
{{< include /code_examples/ch07_contrastive_learning/domainadaptedcontrastive.py >}}
```

**Adaptation 3: Production-Scale Data Loading**

```python
{{< include /code_examples/ch07_contrastive_learning/contrastivedataset.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/inbatchhardnegativemining.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/queuebasedhardnegativemining.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/offlinehardnegativemining.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/debiasedhardnegativemining.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/gradientaccumulationcontrastive.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/distributedcontrastivelearning.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/mixedprecisioncontrastive.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/smartbatchsampler.py >}}
```
...
```python
{{< include /code_examples/ch07_contrastive_learning/multinodecontrastivelearning.py >}}
```bash
    # SLURM example
...
```python
{{< include /code_examples/ch07_contrastive_learning/memoryefficientcontrastive.py >}}
```

### Communication-Efficient Distributed Training

```python
{{< include /code_examples/ch07_contrastive_learning/communicationefficientdistributed.py >}}
```
