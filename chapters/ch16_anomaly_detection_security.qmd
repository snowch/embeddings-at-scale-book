...
```python
{{< include /code_examples/ch16_anomaly_detection_security/from.py >}}
```
...
```python
{{< include /code_examples/ch16_anomaly_detection_security/from_1.py >}}
```
...
```python
{{< include /code_examples/ch16_anomaly_detection_security/from_2.py >}}
```
...
```python
{{< include /code_examples/ch16_anomaly_detection_security/class.py >}}
```
...
```python
{{< include /code_examples/ch16_anomaly_detection_security/behavioral_anomaly_example.py >}}
```
